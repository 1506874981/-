...
//    view1.alpha = 0.7;
    ...
    view2.layer.shadowColor = [UIColor lightGrayColor].CGColor;
    view2.layer.shadowOffset = CGSizeMake(0.0f, 5.0f);
    view2.layer.shadowOpacity = 0.5f;
    view2.layer.shadowPath = shadowPath.CGPath;
    
    view3.layer.masksToBounds = NO;
    view3.layer.shadowColor = [UIColor lightGrayColor].CGColor;
    view3.layer.shadowOffset = CGSizeMake(0.0f, 5.0f);
    view3.layer.shadowOpacity = 0.5f;
    view3.layer.shadowPath = shadowPath.CGPath;
...
-(CATransform3D)transFormFrom:(CGFloat)position
{
    ...
    CATransform3D transformlat=CATransform3DMakeTranslation(0, latx, 0);
